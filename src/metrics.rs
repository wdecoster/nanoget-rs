...
impl ReadMetrics {
    ...
    pub fn with_alignment(mut self, aligned_length: u32, aligned_quality: Option<f64>, 
                         mapping_quality: Option<u8>, percent_identity: Option<f64>) -> Self {
    ...
    pub fn with_sequencing_metadata(mut self, channel_id: Option<u16>, 
...
impl MetricsCollection {
    ...
    pub fn dataset_names(&self) -> Vec<String> {
        let mut names: Vec<String> = self.reads.iter()
    ...
    pub fn filter_by_length(&self, min_length: u32) -> MetricsCollection {
        let filtered_reads: Vec<ReadMetrics> = self.reads.iter()
...
impl MetricsSummary {
    ...
    pub fn from_reads(reads: &[ReadMetrics]) -> Self {
        ...
        let mapping_qualities: Vec<f64> = reads.iter()
        ...
        let percent_identities: Vec<f64> = reads.iter()
